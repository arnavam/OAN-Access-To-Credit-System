...
| :----------------------- | :----- | :------- | :------ | :------------------------------------------------------------------------------ |
| **`product_id`** | string | Yes      | —      | The document name/ID of the loan product                                        |
| **`status`**     | string | Yes      | —      | Exactly one of:`Draft`, `Active`, `Archived` (enforced via regex `^(Draft |
...
### 6.5 `GET /api/method/oan_a2c.api.v1.seller.onboarding.get_bank_status`
...
### 6.6 `POST /api/method/oan_a2c.api.v1.seller.onboarding.update_bank_status`
...
| **`new_status`** | string | Yes      | —      | Exactly one of:`Onboarding`, `Active`, `Suspended` (enforced via regex `^(Onboarding |
...
### 6.7 `POST /api/method/oan_a2c.api.v1.seller.onboarding.invite_user`
...
### 6.8 `POST /api/method/oan_a2c.api.v1.seller.onboarding.deactivate_user`
...
### 6.9 `GET /api/method/oan_a2c.api.v1.seller.onboarding.list_users`
...
### 6.10 `POST /api/method/oan_a2c.api.v1.seller.onboarding.update_user_profile`
