...
export function LoanProductCreatedSuccess({ onDone }: LoanProductCreatedSuccessProps) {
  return (
    <div className="flex flex-col items-center justify-center p-16 text-center h-[450px] max-h-[60vh]">
