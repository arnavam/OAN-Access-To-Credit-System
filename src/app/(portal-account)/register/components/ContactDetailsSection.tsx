...
export function ContactDetailsSection({ isAgreed, setIsAgreed }: ContactDetailsSectionProps) {
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex space-x-3">
            ...
            <button
              ...
              className="bg-[#16A34A] hover:bg-[#15803d] text-white px-4 py-2.5 rounded-lg font-bold text-[14px] transition-colors whitespace-nowrap shadow-sm disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#16A34A]"
            >
              Send OTP
            </button>
          </div>
          ...
          <div className="flex space-x-3">
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className={`flex items-center justify-between w-[100px] px-3 py-2.5 bg-white border rounded-lg text-[14px] text-[#1F2937] focus:outline-none transition-all ${isPhoneDropdownOpen ? 'border-[#16A34A] ring-2 ring-[#16A34A]/20' : 'border-[#D1D5DB]'
                  }`}
              >
              ...
              <div
                className={`absolute top-full left-0 mt-1 w-full bg-white border border-[#E5E7EB] rounded-lg shadow-lg overflow-hidden z-10 transition-all duration-200 origin-top ${isPhoneDropdownOpen
              ...
              >
                {['+255', '+251', '+1'].map((code) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 text-[14px] hover:bg-gray-50 transition-colors ${selectedPhoneCode === code ? 'bg-[#F0FDF4] text-[#16A34A] font-medium' : 'text-[#374151]'}`}
                  >
                    {code}
                  </button>
                ))}
