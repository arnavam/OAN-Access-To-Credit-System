...
const TEXT_FIELD_STYLES: Record<ProductFieldVariant, { label: string; input: string; inputError: string; error: string }> = {
  add: {
    ...
    inputError: 'w-full rounded-xl border px-3.5 py-2 text-xs text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#16A34A]/20 border-red-400 focus:border-red-400',
