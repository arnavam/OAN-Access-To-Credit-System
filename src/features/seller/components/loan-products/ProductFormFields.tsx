...
const TEXT_FIELD_STYLES: Record<ProductFieldStyle, { label: string; input: string; inputError: string; error: string }> = {
  add: {
    ...
    input: 'w-full rounded-lg border px-3.5 py-3 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#16A34A]/20 border-gray-300 focus:border-[#16A34A]',
