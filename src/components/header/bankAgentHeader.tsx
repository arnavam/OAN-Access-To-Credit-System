...
import { Menu, Bell, Globe, ChevronDown, Settings, LogOut, ClipboardCheck, ShieldCheck } from 'lucide-react';
...
export function DashboardTopNav({ onMenuClick, title = "Dashboard" }: TopNavProps) {
  ...
  const userName = "Alemayehu Getachew";
          ...
          {isProfileOpen && (
            <div className="absolute right-0 top-full mt-2 w-48 bg-white border border-gray-100 rounded-xl shadow-lg py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
              <div className="px-4 py-2 border-b border-gray-50 mb-1">
                ...
                <p className="text-xs text-gray-500">Bank Agent</p>
              </div>
              ...
              <Link href="/login/bank-agent" className="w-full flex items-center gap-3 px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors mt-1 border-t border-gray-50 pt-3">
