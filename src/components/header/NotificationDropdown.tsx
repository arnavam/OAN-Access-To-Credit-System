...
export const NotificationDropdown: React.FC<NotificationDropdownProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      ref={dropdownRef}
      className="fixed right-4 sm:right-6 top-[72px] mt-2 w-[calc(100vw-32px)] sm:w-[380px] max-w-[340px] sm:max-w-none bg-white border border-gray-100 rounded-2xl shadow-xl z-[250] overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200"
    >
      {/* Header */}
